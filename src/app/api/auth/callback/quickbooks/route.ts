...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Check if this tenant was already classified AND this isn't a fresh add_company flow
    if (!isAddCompany && tenant.is_firm_company !== null && tenant.is_firm_company !== undefined) {
